      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href={`/reset-password`} className="font-semibold text-indigo-600   hover:text-indigo-50">
                    Esqueceu sua senha?
                  </a>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500 dark:text-white">
            Não tem uma conta?{" "}
            <a href={`/sign-up`} className="font-semibold text-indigo-600 hover:text-indigo-50">
              Crie uma agora
            </a>
          </p>
        </div>
